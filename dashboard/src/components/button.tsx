...
export function Button({
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center gap-1.5 rounded-lg text-sm font-medium transition-colors cursor-pointer ${sizeStyles[size]} ${variantStyles[variant]} ${className ?? ""}`}
      {...props}
    >
